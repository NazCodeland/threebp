...
def get_price(symbols, timeframe="1mo", interval="1d"):
    start_time = time.time()
    data = yf.download(tickers=symbols, period=timeframe, interval=interval)
    end_time = time.time()
...
all_symbols_set = set(symbols)
print('(len(all_symbols_set)', len(all_symbols_set))
print('all_symbols_set', all_symbols_set)

# Create a set of all symbols for which data was fetched
fetched_symbols_set = set(prices.keys())
print('fetched_symbols_set', fetched_symbols_set)

# Find the symbols for which data was not fetched
not_fetched_symbols = all_symbols_set - fetched_symbols_set

# Print the symbols for which data was not fetched
print(f"Symbols for which data was not fetched: {not_fetched_symbols}")
...
#         # If the symbol is already in the set, it's a duplicate
